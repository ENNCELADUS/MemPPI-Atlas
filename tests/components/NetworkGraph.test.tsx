...
beforeAll(() => {
  Object.defineProperty(HTMLElement.prototype, 'getBoundingClientRect', {
    configurable: true,
    value() {
      return { width: 600, height: 600, top: 0, left: 0, bottom: 600, right: 600 };
    },
  });
});
...
describe('NetworkGraph component', () => {
  ...
  it('displays tooltip when node hover event is emitted', async () => {
    ...
    const core = cytoscapeMock.__core as ReturnType<typeof createCoreMock> | undefined;
    expect(core).toBeDefined();
    const hoverCall = core?.on.mock.calls.find((call) => call[0] === 'mouseover');
    ...
    expect(screen.getByText(/Family:/).parentElement).toHaveTextContent('Family: TF');
  });
});
