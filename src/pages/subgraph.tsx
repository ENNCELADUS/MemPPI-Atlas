    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="p-6">
        ...
        {!loading && !error && data && (
          ...
          <aside className="w-full shrink-0 lg:w-[420px] xl:w-[500px]">
            <div className="flex flex-col gap-6">
              <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
                <h2 className="text-sm font-semibold uppercase tracking-wide text-gray-500">Node Information</h2>
                <p className="mt-2 text-sm text-gray-500">Detailed table coming in Milestone 10.</p>
              </div>
              <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
                <h2 className="text-sm font-semibold uppercase tracking-wide text-gray-500">Edge Information</h2>
                <p className="mt-2 text-sm text-gray-500">Detailed table coming in Milestone 10.</p>
              </div>
            </div>
          </aside>
